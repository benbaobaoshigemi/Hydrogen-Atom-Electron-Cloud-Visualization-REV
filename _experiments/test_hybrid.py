# -*- coding: utf-8 -*-
"""Test Hybrid Exchange Coefficients.
Inter-shell: Use INTERMEDIATE (c_k * (2l_source+1))
Intra-shell: Use BARE
"""
import numpy as np
...
print("TESTING HYBRID COEFFICIENTS")
print("Inter-shell: BARE * (2l_source+1)")
print("Intra-shell: BARE")
print("=" * 70)
    ...
    for target_name in config.keys():
        ...
        for source_name, (source, R_j, P_j, n_j) in orbitals.items():
            ...
            for k, c_k in coeffs:
                ...
                # Formula: (n_j/2) * scale * c_k_BARE * Gk
